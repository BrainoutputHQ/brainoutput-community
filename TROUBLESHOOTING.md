...
- Install ollama and pull a model: `ollama pull qwen2.5:3b`. Confirm it serves:
...
on CPU). Use a **smaller** model for routine work (e.g. `qwen2.5:3b`) or a **local GPU** endpoint;
